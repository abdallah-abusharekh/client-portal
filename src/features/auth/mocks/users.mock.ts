...
export const freelancerUser: FreelancerUser = {
  ...
  bio: "Passionate about building scalable web apps. 5+ years experience in React, Node.js, and cloud infrastructure.",
...
export const customerUser: CustomerUser = {
  ...
  bio: "Focused on delivering value to clients and leading cross-functional teams to success.",
